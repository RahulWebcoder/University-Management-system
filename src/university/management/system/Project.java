...
public class Project extends JFrame implements ActionListener{
    Project(){
        super("Konkan Gyanpeeth University Management System");
        ImageIcon jj =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/logo1.png"));
        Image x1 = jj.getImage().getScaledInstance(75, 50,Image.SCALE_DEFAULT);
        ImageIcon jjx1 = new ImageIcon(x1);
        JLabel k1 = new JLabel(jjx1);
